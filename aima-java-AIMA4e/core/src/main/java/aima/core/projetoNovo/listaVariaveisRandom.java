...
public class listaVariaveisRandom {
	...
	public listaVariaveisRandom(){
		...
		// Declara��o dos valores possiveis para
		...
		// Declara��o das listas de vari�veis.
		...
		//Randomiza��o da lista do caso 1.
		for (int i = 0; i < 3; i++) {
		...
		//Randomiza��o da lista do caso 2.
		for (int i = 0; i < 5; i++) {
			Random generator = new Random();
			int randomIndex = generator.nextInt(tempoTotal.length);
		...
		//Randomiza��o da lista do caso 3.
		for (int i = 0; i < 8; i++) {
			Random generator = new Random();
			int randomIndex = generator.nextInt(tempoTotal.length);
			double tempo = tempoTotal[randomIndex];
